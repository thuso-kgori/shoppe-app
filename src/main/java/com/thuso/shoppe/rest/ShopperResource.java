...
public class ShopperResource {
    ...
    @Operation(summary = "Lists all relevant Products a customer can purchase.",
            description = "Fetches all available Products from the shop that a customer can view and decide on which to purchase.")
    ...
    @Operation(summary = "Processes the supplied order by the customer.",
            description = "Processes the supplied order by the customer and facilitates business process for finalising the order.")
